...
[octagonal-wheels](../../../modules.md) / [BackedQueue](../../README.md) / [BackedQueueTypes](../README.md) / QueueError

# Class: QueueError

Defined in: [src/BackedQueue/BackedQueueTypes.ts:32](https://github.com/vrtmrz/octagonal-wheels/blob/main/src/BackedQueue/BackedQueueTypes.ts#L32)
...
- [`QueueOperationError`](../QueueOperationError/README.md)
- [`QueueTimeoutError`](../QueueTimeoutError/README.md)
- [`QueueAbortError`](../QueueAbortError/README.md)
...
```ts
new QueueError(message: string, options?: {
  cause?: unknown;
  status?: number;
}): QueueError;
```
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="cause"></a> `cause?` | `public` | `Error` | - | `LSError.cause` | [src/common/error.ts:14](https://github.com/vrtmrz/octagonal-wheels/blob/main/src/common/error.ts#L14) |
| <a id="message"></a> `message` | `public` | `string` | - | `LSError.message` | node\_modules/typescript/lib/lib.es5.d.ts:1077 |
| <a id="name"></a> `name` | `public` | `string` | - | `LSError.name` | [src/common/error.ts:13](https://github.com/vrtmrz/octagonal-wheels/blob/main/src/common/error.ts#L13) |
| <a id="overridestatus"></a> `overrideStatus?` | `public` | `number` | - | `LSError.overrideStatus` | [src/common/error.ts:15](https://github.com/vrtmrz/octagonal-wheels/blob/main/src/common/error.ts#L15) |
| <a id="stack"></a> `stack?` | `public` | `string` | - | `LSError.stack` | node\_modules/typescript/lib/lib.es5.d.ts:1078 |
| <a id="preparestacktrace"></a> `prepareStackTrace?` | `static` | (`err`: `Error`, `stackTraces`: `CallSite`[]) => `any` | Optional override for formatting stack traces **See** https://v8.dev/docs/stack-trace-api#customizing-stack-traces | `LSError.prepareStackTrace` | node\_modules/@types/node/globals.d.ts:28 |
| <a id="stacktracelimit"></a> `stackTraceLimit` | `static` | `number` | - | `LSError.stackTraceLimit` | node\_modules/@types/node/globals.d.ts:30 |
