...
[octagonal-wheels](../../../modules.md) / [databases](../../README.md) / [dbcommon](../README.md) / ErrorDatabaseDestroyed

# Class: ErrorDatabaseDestroyed

Defined in: [src/databases/dbcommon.ts:17](https://github.com/vrtmrz/octagonal-wheels/blob/main/src/databases/dbcommon.ts#L17)
...
```ts
new ErrorDatabaseDestroyed(message: string, options?: {
  cause?: unknown;
  status?: number;
...
| <a id="name"></a> `name` | `public` | `string` | `"ErrorDatabaseDestroyed"` | - | [`DatabaseError`](../DatabaseError/README.md).[`name`](../DatabaseError/README.md#name) | - | [src/databases/dbcommon.ts:18](https://github.com/vrtmrz/octagonal-wheels/blob/main/src/databases/dbcommon.ts#L18) |
