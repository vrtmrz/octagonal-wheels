...
[octagonal-wheels](../modules.md) / conduit

# conduit

## Classes

- [NamedInstance](NamedInstance/README.md)
- [PostMessageBackbone](PostMessageBackbone/README.md)
...
- [Callee](Callee/README.md)
- [Caller](Caller/README.md)
- [ConnectorFunc](ConnectorFunc/README.md)
...
- [\_createTransporter](_createTransporter/README.md)
