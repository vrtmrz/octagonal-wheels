 ...
 * @template T The type of the values stored in the store.
 */
export abstract class SimpleStoreBase<T, TBackend = any> implements SimpleStore<T, TBackend> {
    /**
...
export abstract class ExtendedSimpleStore<T, TBackend = any>
    extends SimpleStoreBase<T, TBackend>
    implements SimpleStoreCRUDSupportTransaction<T>
{
    /**
     ...
     */
    public static open: <T>(name: string, instanceName?: string) => ExtendedSimpleStore<T>;
    /**
     ...
     */
    public static getActiveInstance: <T>(instanceName: string) => ExtendedSimpleStore<T> | undefined;
    /**
     ...
     */
    public static hasActiveInstance: (instanceName: string) => boolean;
    /**
     ...
     */
    public static deleteDatabase: (instanceName: string) => Promise<void>;
