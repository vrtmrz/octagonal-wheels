 ...
 */
export class LSError extends Error implements ErrorWithCause {
...
export class LSFatalError extends LSError {}

export function wrapError<T>(func: () => Promise<Awaited<T>>): Promise<Awaited<T> | LSError> {
