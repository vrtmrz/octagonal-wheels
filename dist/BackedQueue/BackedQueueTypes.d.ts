 ...
 */
export declare class QueueError extends LSError {
}
/**
 ...
 */
export declare class QueueTimeoutError extends QueueError {
}
/**
 * Error class for queue cancellation errors.
 */
export declare class QueueAbortError extends QueueError {
}
/**
 ...
 */
export declare const RequeuePosition: {
    /**
     ...
     */
    readonly DANGER_KEEP_ORIGINAL: 0;
    /**
 ...
 */
export type DequeueCallback<T> = (items: DequeuedItem<T>, context: QueueProcessContext) => Promise<any | void> | any | void;
/**
 ...
 */
export declare const PREFIX_BACKED_QUEUE_PERSISTENT = "bq-p";
/**
 ...
 */
export declare const PREFIX_BACKED_QUEUE_HALF_PERSISTENT = "bq-h";
