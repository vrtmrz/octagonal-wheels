 ...
 */
export declare function withConcurrency<T, U>(iterable: Iterable<T> | AsyncIterableIterator<T>, callback: (t: T) => Promise<U>, concurrency: number): AsyncIterableIterator<U>;
/**
 * Just like an filter function in the Array, but this function is asynchronous.
 * @param iterable Source iterable.
 * @param callback Filtering function.
 */
export declare function filter<T>(iterable: Iterable<T> | AsyncIterableIterator<T>, callback: (t: T) => boolean | Promise<boolean>): AsyncIterableIterator<T>;
/**
 ...
 * @param concurrency  the number of concurrent processes.
 */
export declare function asyncMapWithConcurrency<T, U>(iterable: Iterable<T> | AsyncIterableIterator<T>, callback: (t: T) => Promise<U>, concurrency: number): AsyncIterableIterator<U>;
